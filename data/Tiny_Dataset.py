...
class TinyDataset(object):
    ...
    def __next__(self):
        ...
        if self.batch_count < self.num_batchs:
            ...
            # input = [batch_image, batch_label_sbbox, batch_sbboxes, batch_label_mbbox, batch_mbboxes, batch_label_lbbox, batch_lbboxes]
            # output = []
            # return input, output
    ...
    def preprocess_true_boxes(self, bboxes):
        label = [
            np.zeros((self.train_output_sizes[i], self.train_output_sizes[i], self.anchor_per_scale, 5+self.num_classes))
            for i in range(2)]
...
if __name__ == '__main__':
    ...
    dataGenerator = TinyDataset('train')
    batch_image, batch_target = next(dataGenerator)

    batch_medium_target, batch_larger_target = batch_target
